...
function ForgotPasswordTemplate({firstName, lastName, code}) {
  return (
    <Html>
        <Tailwind>
            <Container>
                <Heading as="h2">Dear {firstName.charAt(0)}{firstName.slice(1)} {lastName.charAt(0)}{lastName.slice(1)}, </Heading>
                <Text>Kindly use the code below to reset the password of your account. Please note that this code expires in 30 minutes.</Text>
