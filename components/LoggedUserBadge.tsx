  ...
  return (
    <div className="hidden lg:flex gap-2 items-center relative">
        ...
        <div className="flex cursor-pointer items-center" onClick={() => setUserBadgeDropDown(prev => !prev)}>
          <Image src={loggedUser?.gender === 'male' ? maleUser : loggedUser?.gender === 'female' ? femaleUser : defaultUser } alt='user profile picture' width={55} height={60} className="min-[2000px]:w-[80px] min-[2000px]:h-[80px] "  />
